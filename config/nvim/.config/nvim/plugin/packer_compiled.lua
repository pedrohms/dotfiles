...
_G.packer_plugins = {
  ...
  ["cmp-dap"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/cmp-dap",
  ...
  ["color-picker.nvim"] = {
    ...
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/color-picker.nvim",
  ...
  ["dap-install"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/dap-install",
  ...
  ["eyeliner.nvim"] = {
    ...
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/eyeliner.nvim",
  ...
  ["lsp_lines.nvim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/lsp_lines.nvim",
  ...
  ["nord-vim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/nord-vim",
  ...
  ["nvim-spectre"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/nvim-spectre",
  ...
  ["vim-gist"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/vim-gist",
  ...
  ["webapi-vim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/webapi-vim",

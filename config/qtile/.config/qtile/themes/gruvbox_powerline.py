...
def init_secondary_widgets_list(monitor_num):
    ...
    del secondary_widgets_list[16:18]
...
screens = [
    ...
    Screen(bottom=bar.Bar(widgets=secondary_widgets_list, size=24, background=backgroundColor, margin=0, opacity=0.8),),
    ]
